...
/*
-Pure virtual function is used to make abstract base class through which we cannot make objects
-abstract base class->make virtual function and make dervied class
    through which we make pointers and run that particular function
abstract base class is the class which contains at least one pure virtual class
*/